...
class SortByFullFilterScreen extends StatefulWidget {
  const SortByFullFilterScreen(
  ...
  @override
  _SortByFullFilterScreenState createState() => _SortByFullFilterScreenState();
}

class _SortByFullFilterScreenState extends State<SortByFullFilterScreen> {
                                    ...
                                    onChanged: (String? value) {
                                      ...
                                      if (value != null) {
                                        if (index == 0) {
                                          ...
                                          context.read<ProductFilterBloc>().add(
                                              SetSortByEvent("price", "asc"));
                                        } else if (index == 3) {
                                          context.read<ProductFilterBloc>().add(
                                              SetSortByEvent("price", "desc"));
                                        }
                                      }
                                    }),
                              ],
